      ...
      <div className="registerContent">
        {!success ? <>
          ...
          <form className="registerForm" onSubmit={submit}>
            ...
            {message&&<p className="registerMessage">{message}</p>}<button className="registerSubmit" disabled={sending}>{sending?'Kreiranje članstva...':'Postani članica　⟶'}</button><p className="loginPrompt">Već imaš račun? <a href="/club/login">Prijavi se.</a></p>
          </form>
